...
const zeroPadLeft = (str: string | number, zeroes = 3) => `${'0'.repeat(Math.max(0, zeroes - String(str).length))}${str}`;

export default (code: string | number) => codeToName[zeroPadLeft(code)];
